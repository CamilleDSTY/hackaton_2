...
--
-- Host: localhost    Database: emaus_connect
-- ------------------------------------------------------
...
--
-- Table structure for table `config_min`
--

DROP TABLE IF EXISTS `config_min`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `ram` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nb_ram` enum('1','2','3','4','6','8','12','16') NOT NULL,
  `value` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `storage` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nb_storage` enum('16','32','64','128','256','512','1024') DEFAULT NULL,
  `value` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-28 16:48:07
